			...
			<tr>
			  ...
			  <td valign="top">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="640" align="center" summary="">
				  ...
				  <tr><td class="featuredImage"><h1 align="center" style="font-size:48px;">Pedido aceito!</h2></td></tr>
		...
		$msg .='
						...
						<table>
							...
							<tr>
								...
								<td>
								     <p>Oba! seu Pedido foi aceito por um de nossos profissionais!.</p>
									 <p>Código:0'.$agenda.'</p>
									<br />
									<p> '.$ped.' </p>									
					...
					$mail->AddBCC('inf@pinkmajesty.com', 'Pink');
 
					$mail->SMTPDebug = 1;
					$mail->IsHTML(true); // Define que o e-mail será enviado como HTML
					$mail->CharSet = 'utf-8'; // Charset da mensagem (opcional)
					$mail->Subject  = "Pedido 0".$agenda." Aceito, ".$ped; // Assunto da mensagem
