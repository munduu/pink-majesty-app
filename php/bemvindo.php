...
$msg .='
	...
	<html>
	  ...
	  <head>   
		...
		<title>Comprovante de Inscrição Evento Sport Bro - <?=$titulo?></title>
			...
			<tr>
			  ...
			  <td valign="top">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="640" align="center" summary="">
				  ...
				  <tr><td class="featuredImage"><h1 align="center" style="font-size:48px;">Seja Bem Vindo(a)!</h2></td></tr>
	...
	';
		...
		$msg .='
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<p>Sr.(a) '.$nome.', Seja bem vindo(a) ao Pink Majesty.</p>

									<br />

									<p>Agora você conta com a área exclusiva e pode ter acesso ao aplicativo! </p>
						...
						Site: www.pinkmajesty.com.br <br />

						E-mail: contato@pinkmajesty.com.br </p>
					...
					$mail->AddAddress($email_cliente, $razao_social_clt); 

					

					//$mail->AddAddress('mardenmoreira1@gmail.com', 'Marden');

					//$mail->AddCC('marden@mundoinova.com.br', 'Marden'); 

					$mail->AddBCC('borishcs@gmail.com', 'Boris');

					//$mail->AddBCC('contato@dellasbeleza.com.br', 'Dellas');

					//$mail->AddCC('financeiro@unitracker.com.br', 'Fabiana');

					//$mail->AddCC('financeiro@unitracker.com.br', 'Unitracker'); 
					...
					$mail->Subject  = $f_name."Seja Bem Vindo(a), Ative seu Cadastro"; // Assunto da mensagem
				...
				<table border="0" cellspacing="0" cellpadding="0" width="640" align="center" summary="">
				  ...
				  <tr>
					...
					<td class="footNotes" align="right">
					  ...
					  <a href="https://www.facebook.com/pinkmajesty" title="Facebook"><img src="https://sportbro.com.br/sportbro/img/faceb.png" width="29" alt="Facebook" /></a>
