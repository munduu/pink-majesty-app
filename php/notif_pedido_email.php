				  ...
				  <tr>
					...
					<td class="logoContainer">
					  ...
					  <a href="/" title="Lorem logo">
						...
						<img class="logo" src="https://igestaoweb.com.br/pinkmajesty/img/logod" width="100" alt="Lorem logo" />
			...
			<tr>
			  ...
			  <td valign="top">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="640" align="center" summary="">
				  ...
				  <tr><td class="featuredImage"><h1 align="center" style="font-size:48px;">Voce tem novo(s) Pedido(s)!</h2></td></tr>
	...
	';
		...
		$msg .='
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<p>clique na agenda no menu Pedidos Feitos, realize o aceite do serviço antes que alguem faça antes de voce!</p>
					...
					for($index = 0; $index <= count($result); $index ++){
						...
						echo $email_prof = $result[$index];
						$mail->AddBCC($email_prof);
					...
					$mail->Subject  = "Boas Noticias, Novo pedido recebido!"; // Assunto da mensagem
