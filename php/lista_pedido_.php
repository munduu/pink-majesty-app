				...
				<div id="produto_total">
					...
					<div class="partes_categoria" align="center">
						<h4 class="list-group-item-heading">
							...
							<div class="btn_troca_cartao">
							<i class="fa fa-credit-card-alt" aria-hidden="true" style="color:#ec268f;"></i> ****'.substr($lNcartao, -4).' '.$n_tipo.'</div><br /><br />
							';
						if(!empty($id_colaborador)){
							if(empty($foto)){$foto = 'imagem_teste.gif';}
							//<img src="'.$url_img.'igestao/imagem_col/'.$foto.'">
							$url_bsc = $url_img.'igestao/imagem_col/'.$foto;
							$dados.= '
						...
						if($situacao =='ACEITO'){
							$dados.= '
							<div align="center">
						 		<button name="btn_pagamento" class="btn_pagamento btn" alt="'.$id.'" data-uib="twitter%20bootstrap/button" data-ver="1" style="display:block">Realizar Pagamento</button>
