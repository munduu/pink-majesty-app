...
class CreateAuthorization
{
    ...
    public static function main()
    {
        ...
        try {
             ...
             */
            $credentials = new PagSeguroAccountCredentials("financeiro@vistatshirt.com", "8E878550D14C4A80B9272CFBFEC75DC7");
    ...
    public static function printAuthorizationReturn($authorization)
    {
        ...
        if ($authorization) {
            ...
            if(filter_var($authorization, FILTER_VALIDATE_URL)) {
				$auto = explode('?code=',$authorization);
                echo "<p><strong>URL: </strong>" . $auto[1] . "</p> ";
