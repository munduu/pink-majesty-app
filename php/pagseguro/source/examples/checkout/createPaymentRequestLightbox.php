...
class CreatePaymentRequestLightbox
{
    ...
    public static function main()
    {
        ...
        $paymentRequest->addItem('0001', 'Notebook prata', 1, 1.00);

        // Add another item for this payment request
        $paymentRequest->addItem('0002', 'Notebook rosa', 1, 1.00);
        ...
        $paymentRequest->setSender(
            'João Comprador',
            'c28930709261057990606@sandbox.pagseguro.com.br',
            '11',
            '56273440',
            'CPF',
            '156.009.442-76'
        ...
        $paymentRequest->setRedirectUrl("https://www.6ad.com.br/projetos/flyer/");
        ...
        try {
            ...
            $credentials = new PagSeguroAccountCredentials("alesneak@hotmail.com",
                "0F356D86F9A44A59ABF6768C537CE214");
